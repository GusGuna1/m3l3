...
@bot.command(name='new_project')
    # untuk membuat projek baru ketika !new_project dipanggil
...
@bot.command(name='projects')
    # untuk memperlihatkan projek ketika !projects dipanggil
...
@bot.command(name='skills')
    # untuk memperlihatkan skills ketika !skills dipanggil
...
@bot.command(name='delete')
    # untuk menghapus project ynag kita pilih ketika !delete dipanggil
...
@bot.command(name='update_projects')
    # untuk memperbarui data project ketika !update_project dipanggil
